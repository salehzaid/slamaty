#!/usr/bin/env python3
"""
Test script to create a new round with deadline and end_date
"""
...
def test_create_round():
    """Test creating a new round with deadline and end_date"""
    
    base_url = "http://localhost:8000"
    
    print("=" * 80)
    print("اختبار إنشاء جولة جديدة مع deadline و end_date")
    print("=" * 80)
    ...
    try:
        ...
        round_type = round_types[0]["name"] if round_types else "quality_round"
        ...
        round_data = {
            ...
            "deadline": deadline_days,  # عدد الأيام
            "priority": "medium",
        ...
        print(f"   المهلة: {round_data['deadline']} أيام")
        print(f"   تاريخ الانتهاء المتوقع: {end_date.strftime('%Y-%m-%d')}")
